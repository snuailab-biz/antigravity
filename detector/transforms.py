...
'''
Train시 사용할 transform.
하지만 아직 정상적으로 동작하지 않음.
그 이유는 keypoint에 대해 정의가 아직 안내려졌음. 0,1,2,3,4,5,6 의 위치 
_flip_coco_whole_pad_keypoints 이 함수의 flip시에 keypoint가 어디어디에 대한.. 
'''
...
def _flip_coco_whole_pad_keypoints(kps, width):
        ...
        if torch.rand(1) < self.p:
            ...
            if target is not None:
                ...
                if "keypoints" in target:
                    ...
                    keypoints = _flip_coco_whole_pad_keypoints(keypoints, width)
